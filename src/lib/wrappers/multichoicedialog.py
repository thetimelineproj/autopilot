...
wxMultiChoiceDialog = wx.MultiChoiceDialog


class MultiChoiceDialog(wx.MultiChoiceDialog, Wrapper):

    def __init__(self, *args, **kw):
        wxMultiChoiceDialog.__init__(self, *args, **kw)
    ...
    def ShowModal(self, *args, **kw):
        ...
        super(MultiChoiceDialog, self).ShowModal(*args, **kw)

    @Overrides(wxMultiChoiceDialog)
    def IsShown(self):
        return self.shown
    ...
    def _register_and_explore(self):
        MultiChoiceDialog.register_win(self)
        self._explore()

    @classmethod
    def wrap(self, register_win):
        wx.MultiChoiceDialog = MultiChoiceDialog
        MultiChoiceDialog.register_win = register_win
