...
wxSingleChoiceDialog = wx.SingleChoiceDialog


class SingleChoiceDialog(wx.SingleChoiceDialog, Wrapper):

    def __init__(self, *args, **kw):
        wxSingleChoiceDialog.__init__(self, *args, **kw)
    ...
    def ShowModal(self, *args, **kw):
        ...
        super(SingleChoiceDialog, self).ShowModal(*args, **kw)

    @Overrides(wxSingleChoiceDialog)
    def IsShown(self):
        return self.shown
    ...
    def _register_and_explore(self):
        SingleChoiceDialog.register_win(self)
        self._explore()

    @classmethod
    def wrap(self, register_win):
        wx.SingleChoiceDialog = SingleChoiceDialog
        SingleChoiceDialog.register_win = register_win
