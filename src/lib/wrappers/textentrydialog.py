...
wxTextEntryDialog = wx.TextEntryDialog


class TextEntryDialog(wx.TextEntryDialog, Wrapper):

    def __init__(self, *args, **kw):
        wxTextEntryDialog.__init__(self, *args, **kw)
    ...
    def _register_and_explore(self):
        TextEntryDialog.register_win(self)
        self._explore()

    @classmethod
    def wrap(self, register_win):
        wx.TextEntryDialog = TextEntryDialog
        TextEntryDialog.register_win = register_win
